...
public class CSEEnrollment extends EnrollCourse{
    ...
    public CSEEnrollment(String dept,String Std_Name,String Email,String Address,String Mobile_No,String Student_Gender){
    ...
    public void GetDetails(){
        ...
        System.out.println("Enter the DayScholar or Hosteler: ");
    ...
    public int feesDetails(){
        seats.put("CSE", seats.get("CSE")-1);
        System.out.println("Fees Deatils ");
        int totalfees = 0;
        if(stay_type.equals("Day_Scholar")){
            if(Student_Education_Type.equals("Management")) {
                System.out.println("College Fees : 1.5 Lakh per year");
                totalfees += 150000;
            }
            else{
                System.out.println("College Fees : 90000 Thousands per year");
                totalfees += 90000;
            }
            System.out.println("Bus Fess : 25000 Thousands per year");
            ...
            System.out.println("Application Fees : 5000 Thousand");
            totalfees += 30000;
            System.out.println("Total Fess " + totalfees);
        }
        return totalfees;
