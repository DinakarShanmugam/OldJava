...
public class EEEEnrollment extends EnrollCourse{
    ...
    public EEEEnrollment(String Std_Name,String Email,String Address,String Mobile_No,String Student_Gender){
    ...
    public int feesDetails() {
        seats.put("EEE", seats.get("EEE")-1);
        System.out.println("Fees Deatils ");
        int totalfees = 0;
        if (stay_type.equals("Day_Scholar")) {
            if (Student_Education_Type.equals("Management")) {
                System.out.println("College Fees : 1 Lakh per year");
                totalfees += 100000;
            } else {
                System.out.println("College Fees : 70000 Thousand per year");
                totalfees += 70000;
            }
            ...
            System.out.println("Hostel Fees : 85000 Thousands per year");
            System.out.println("Application Fees : 5000");
            totalfees += 90000;
            System.out.println("Total Fess " + totalfees);
        }
