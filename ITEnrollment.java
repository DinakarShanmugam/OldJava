...
public class ITEnrollment extends EnrollCourse{
    ...
    public ITEnrollment(String Std_Name,String Email,String Address,String Mobile_No,String Student_Gender){
    ...
    public int feesDetails() {
        seats.put("IT", seats.get("IT")-1);
        System.out.println("Fees Deatils ");
        int totalfees = 0;
        if (stay_type.equals("Day_Scholar")) {
            if (Student_Education_Type.equals("Management")) {
                System.out.println("College Fees : 1.25 Lakh per year");
                totalfees += 125000;
            } else {
                System.out.println("College Fees : 85000 Thousands per year");
                totalfees += 85000;
            }
            ...
            System.out.println("Hostel Fees : 85000 per year");
            System.out.println("Application Fees : 5000");
            totalfees += 90000;
            System.out.println("Total Fess " + totalfees);
        }
